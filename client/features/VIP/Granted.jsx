...
const Granted = () => {
    return(
        <>
<div id="titleBox" className="block bg-[pink] text-center w-3/5 m-10 rounded-md shadow-lg shadow-[#EBAF4C] p-8">
            ...
            <div>
                ...
                <a to="" className="block bg-[pink] text-[red] text-3xl text-center w-3/5 m-10 rounded-md shadow-lg shadow-[#EBAF4C] p-4 hover:scale-110 transition duration-300 ease-in-out">Access to luxury rental cars at participating car rental agencies
                    ...
                    <a to="" className="block bg-[pink] text-[red] text-3xl text-center w-3/5 m-10 rounded-md shadow-lg shadow-[#EBAF4C] p-4 hover:scale-110 transition duration-300 ease-in-out">Have access to airport lounges and first class flight options
                        <div className="flex justify-around text-center m-10">
                    ...
                    <a to="" className="block bg-[pink] text-[red] text-3xl text-center w-3/5 m-10 rounded-md shadow-lg shadow-[#EBAF4C] p-4 hover:scale-110 transition duration-300 ease-in-out">Access penthouses and resorts when you travel
                        <div className="flex justify-around text-center m-10">
                    ...
                    <a to="" className="block bg-[pink] text-[red] text-3xl text-center w-3/5 m-10 rounded-md shadow-lg shadow-[#EBAF4C] p-4 hover:scale-110 transition duration-300 ease-in-out">Private viewings at world famous museums
                        <div className="flex justify-around text-center m-10">
