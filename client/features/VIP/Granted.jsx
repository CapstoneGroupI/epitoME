...
const Granted = () => {
    return(
        ...
        <div className="m-8">
        <div id="titleBox" className="text-center w-full m-10 rounded-md p-8">
            <h1 className="text-honey text-5xl font-bold">Congrats! You have been granted VIP status!</h1>
            <h2 className="text-honey text-4xl font-bold mt-4">Please check out your deals below</h2>
        </div>
        ...
        <div className="flex flex-col md:flex-row flex-wrap w-full m-6 my-6 rounded-md shadow-md shadow-honey p-4 justify-around items-center hover:scale-110 transition duration-300 ease-in-out cursor-pointer">
        ...
        <h2 className="text-stone-500 text-3xl text-center mt-6">Have access to airport lounges and first class flight options</h2>
        <div className="flex flex-col md:flex-row flex-wrap w-full m-6 my-6 rounded-md shadow-md shadow-honey p-4 justify-around items-center hover:scale-110 transition duration-300 ease-in-out cursor-pointer">
        ...
        <h2 className="text-stone-500 text-3xl text-center mt-6">Access penthouses and resorts when you travel</h2>
        <div className="flex flex-col md:flex-row flex-wrap w-full m-6 my-6 rounded-md shadow-md shadow-honey p-4 justify-around items-center hover:scale-110 transition duration-300 ease-in-out cursor-pointer">
        ...
        <h2 className="text-stone-500 text-3xl text-center mt-6">Private viewings at world famous museums</h2>
        <div className="flex flex-col md:flex-row flex-wrap w-full m-6 my-6 rounded-md shadow-md shadow-honey p-4 justify-around items-center hover:scale-110 transition duration-300 ease-in-out cursor-pointer">
